            ...
            <form action="{{ route('speaker.createproposal', ['id' => $event->id]) }}" method="POST"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-dark-bg !text-gray-500 focus:ring-2 focus:ring-accent focus:outline-none">{{ old('description') }}</textarea>
