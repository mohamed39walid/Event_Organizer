...
<section id="events" class="py-24 bg-bg dark:bg-dark-bg">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-3 gap-10 max-w-6xl mx-auto">
            ...
            <x-card :eventid="$event['id']" :eventName="$event['eventName']" :date="$event['start-date']"
                :endDate="$event['end-date']" :location="$event['location']" :image="$event['image'] ?? ''"
                :tickets="$event['available_tickets']" :status="$event['status']"
