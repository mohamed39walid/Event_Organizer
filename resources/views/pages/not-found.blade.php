...
@section('main')
    <div class="h-full flex flex-col justify-center items-center px-4 bg-background text-foreground dark:bg-dark-background dark:text-dark-foreground">
        <div class="text-center space-y-6">
            ...
            <!-- Return Button -->
            <a href="{{ url('/') }}"
                class="inline-flex items-center gap-2 px-6 py-3 bg-accent hover:bg-accent-hover text-white font-medium rounded-full transition duration-200 ease-in-out shadow-md">
